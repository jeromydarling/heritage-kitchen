...
-- =========================================================================
-- 20 editions with auto-assembly selectors. Upsert so re-running schema.sql
-- refreshes the selector and metadata without blowing away page_count or
-- PDF paths set by the admin.
-- =========================================================================
insert into editions (slug, title, subtitle, description, price_usd, price_pdf_usd, format, published, featured, sort_order, recipe_ids, lesson_ids, selector)
values
  ('kitchen-school', 'The Kitchen School', 'Fifty lessons from the 1900s home-economics classroom.', 'A lesson-only anthology drawn from ten American home-economics textbooks published between 1869 and 1920. Yeast biology, knife work, wood-stove chemistry, invalid cookery, meal planning, and nutrition, each with an explicit split between what the 1900s got right and what we know better now.', 48, 15, 'both', false, true, 1, '[]'::jsonb, '[]'::jsonb, '{"maxRecipes": 0, "lessonTopics": ["food-science", "bread-and-dough", "nutrition", "fire-and-heat", "kitchen-setup", "sauces", "stocks-and-broths", "measuring-and-weights", "food-safety"], "maxLessons": 50, "sortBy": "category"}'::jsonb),
  ('lenten-table', 'The Lenten Table', 'Forty days of simple food.', 'Meatless weekday suppers, Friday fish, and the breads and grains that carried Christian families through the hungry gap for sixteen hundred years.', 34, 9, 'both', false, true, 2, '[]'::jsonb, '[]'::jsonb, '{"meatless": true, "includeCategories": ["soups-and-stews", "sides-and-vegetables", "main-dishes", "salads", "breads", "breakfast-and-bakes"], "difficulties": ["easy", "moderate"], "maxRecipes": 40, "lessonTopics": ["invalid-cookery", "economy-and-budgeting", "fish-and-seafood", "vegetables", "nutrition"], "maxLessons": 10, "sortBy": "category"}'::jsonb),
  ('advent-pantry', 'The Advent Pantry', 'Four quiet weeks before the feast.', 'Simple suppers for the waiting, make-ahead cookies and breads for the feast that is coming, and a small liturgical calendar of what to start when.', 34, 9, 'both', false, true, 3, '[]'::jsonb, '[]'::jsonb, '{"includeCategories": ["breads", "soups-and-stews", "preserves-and-pickles", "main-dishes", "breakfast-and-bakes"], "difficulties": ["easy"], "maxRecipes": 35, "lessonTopics": ["bread-and-dough", "preserving-and-canning", "meal-planning", "stocks-and-broths", "economy-and-budgeting"], "maxLessons": 10, "sortBy": "category"}'::jsonb),
  ('christmas-twelve-days', 'The Christmas Twelve Days', 'From the Vigil through Epiphany.', 'Plum pudding, fruit cake, mince, wassail, goose, king cake. Twelve days of feasting, laid out the way the old books laid them out.', 36, 11, 'both', false, true, 4, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["plum pudding", "fruit cake", "mince", "wassail", "eggnog", "gingerbread", "goose", "turkey", "king cake", "yule", "christmas"], "celebratory": true, "includeCategories": ["desserts", "candy-and-confections", "main-dishes", "breads", "beverages"], "maxRecipes": 50, "lessonTopics": ["candy-and-sugar-work", "pastry", "roasting", "baking"], "maxLessons": 8, "sortBy": "category"}'::jsonb),
  ('easter-feast', 'Easter Breakfast and Easter Feast', 'Lamb, ham, eggs, and braided sweet breads.', 'The feast of feasts. Everything denied in Lent returns to the table on Easter morning and stays there for fifty days.', 36, 11, 'both', false, true, 5, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["lamb", "ham", "paska", "kulich", "simnel", "hot cross", "braid", "deviled egg", "sweet bread"], "includeCategories": ["main-dishes", "breads", "breakfast-and-bakes", "desserts"], "maxRecipes": 40, "lessonTopics": ["eggs", "dairy", "meat-and-poultry", "pastry"], "maxLessons": 6, "sortBy": "category"}'::jsonb),
  ('summer-table', 'The Summer Table', 'Berries, stone fruit, and the garden at its peak.', 'From St. John the Baptist through the Assumption. Cold soups, salads, stone fruits, preserves begun in June and finished in August.', 34, 9, 'both', false, false, 6, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["strawberry", "cherry", "peach", "berry", "raspberry", "blueberry", "cucumber", "tomato", "lettuce", "cold", "iced"], "includeCategories": ["sides-and-vegetables", "salads", "desserts", "beverages", "preserves-and-pickles"], "difficulties": ["easy"], "maxRecipes": 60, "lessonTopics": ["vegetables", "fruits", "food-safety"], "maxLessons": 6, "sortBy": "category"}'::jsonb),
  ('harvest-home', 'The Harvest Home', 'From the fall equinox to All Saints.', 'Pumpkin, squash, apples, cider, root vegetables, preserves, and the quiet work of putting the year away.', 34, 9, 'both', false, false, 7, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["pumpkin", "squash", "apple", "cider", "pear", "nut", "preserve", "pickle", "jelly", "jam", "chutney", "quince"], "includeCategories": ["preserves-and-pickles", "sides-and-vegetables", "desserts", "beverages"], "maxRecipes": 60, "lessonTopics": ["preserving-and-canning", "food-safety", "economy-and-budgeting", "fruits"], "maxLessons": 10, "sortBy": "category"}'::jsonb),
  ('sunday-dinner', 'The Sunday Dinner', 'The meal you put on the table when people come over.', 'Eighty recipes for the kind of meal that requires a nap afterward. Roasts, sides, a real dessert. The way Sunday used to be.', 38, 11, 'both', false, false, 8, '[]'::jsonb, '[]'::jsonb, '{"celebratory": true, "includeCategories": ["main-dishes", "sides-and-vegetables", "sauces-and-condiments", "desserts"], "difficulties": ["moderate", "involved"], "titleIncludes": ["roast", "stuffed", "braised", "baked"], "maxRecipes": 80, "lessonTopics": ["roasting", "sauces", "stocks-and-broths", "table-setting"], "maxLessons": 10, "sortBy": "category"}'::jsonb),
  ('weeknight-book', 'The Weeknight Book', 'Fast food, the good kind.', 'Sixty recipes that take less than an hour and cost less than takeout. For people with jobs, children, and a 1896 cookbook.', 32, 9, 'both', false, false, 9, '[]'::jsonb, '[]'::jsonb, '{"difficulties": ["easy"], "includeCategories": ["main-dishes", "sides-and-vegetables", "soups-and-stews", "breakfast-and-bakes"], "maxRecipes": 60, "lessonTopics": ["food-science", "meal-planning", "boiling", "economy-and-budgeting"], "maxLessons": 8, "sortBy": "category"}'::jsonb),
  ('table-of-a-sick-friend', 'For the Table of a Sick Friend', 'Broths, puddings, and the old book that knew how to cook for a sick house.', 'The chapter every 1900s cookbook had and almost no modern one keeps: how to feed someone who is sick or convalescing. Buy it for a friend whose parent is in the hospital.', 28, 0, 'both', false, true, 10, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["broth", "custard", "pudding", "gruel", "arrowroot", "jelly", "blanc mange", "barley", "beef tea", "toast", "panada", "poached", "stewed", "milk toast", "rice", "oatmeal"], "difficulties": ["easy"], "excludeCategories": ["candy-and-confections", "beverages"], "maxRecipes": 40, "lessonTopics": ["invalid-cookery", "food-science", "nutrition", "dairy"], "maxLessons": 8, "sortBy": "category"}'::jsonb),
  ('working-budget', 'The Working Budget', 'Feeding a family cheap, the old way.', 'Sixty recipes built on beans, cornmeal, cabbage, potatoes, eggs, and bread. Written for people who had to stretch a dollar, from people who knew how.', 30, 9, 'both', false, false, 11, '[]'::jsonb, '[]'::jsonb, '{"titleIncludes": ["bean", "cabbage", "potato", "cornmeal", "corn meal", "johnny", "hash", "rice", "split pea", "lentil", "bread pudding", "macaroni", "oatmeal", "gruel", "hominy"], "difficulties": ["easy"], "maxRecipes": 60, "lessonTopics": ["economy-and-budgeting", "meal-planning", "boiling", "vegetables"], "maxLessons": 10, "sortBy": "category"}'::jsonb),
  ('bread-and-loaves', 'Bread and Loaves', 'Everything our grandmothers knew about flour and heat.', 'Eighty bread recipes paired with every bread-and-dough lesson in the kitchen school. The definitive Heritage Kitchen bread book.', 40, 12, 'both', false, true, 12, '[]'::jsonb, '[]'::jsonb, '{"includeCategories": ["breads", "breakfast-and-bakes"], "maxRecipes": 80, "lessonTopics": ["bread-and-dough", "baking", "fire-and-heat", "measuring-and-weights"], "maxLessons": 14, "sortBy": "category"}'::jsonb),
  ('essential-fannie-farmer', 'The Essential Fannie Farmer', 'The best of The Boston Cooking-School Cook Book, 1896.', 'One hundred recipes from the most famous American cookbook ever written, modernized for a kitchen Fannie Farmer could not have imagined.', 40, 12, 'both', false, false, 13, '[]'::jsonb, '[]'::jsonb, '{"sourceBooks": ["The Boston Cooking-School Cook Book"], "maxRecipes": 100, "sortBy": "category"}'::jsonb),
  ('mrs-lincolns-boston', 'Mrs. Lincoln''s Boston Cook Book', 'The 1884 predecessor to Fannie Farmer.', 'The quieter, older, arguably better Boston cookbook. Mary Johnson Lincoln taught the class Farmer would one day lead.', 40, 12, 'both', false, false, 14, '[]'::jsonb, '[]'::jsonb, '{"sourceBooks": ["Mrs. Lincoln''s Boston Cook Book"], "maxRecipes": 100, "sortBy": "category"}'::jsonb),
  ('settlement-cook-book', 'The Settlement Cook Book', 'From the Milwaukee settlement house, 1901.', 'Immigrant kitchens, Jewish-American voices, and the cookbook that fed new Americans for generations. Mrs. Simon Kander''s masterpiece.', 40, 12, 'both', false, false, 15, '[]'::jsonb, '[]'::jsonb, '{"sourceBooks": ["The Settlement Cook Book"], "maxRecipes": 100, "sortBy": "category"}'::jsonb),
  ('miss-parloas-new-cook-book', 'Miss Parloa''s New Cook Book', 'The 1887 practical manual.', 'Maria Parloa ran the Boston Cooking School before Lincoln, and her book is the practical voice American cooking learned from.', 40, 12, 'both', false, false, 16, '[]'::jsonb, '[]'::jsonb, '{"sourceBooks": ["Miss Parloa''s New Cook Book"], "maxRecipes": 100, "sortBy": "category"}'::jsonb),
  ('american-womans-home', 'The American Woman''s Home', 'Catharine Beecher, Harriet Beecher Stowe, 1869.', 'The book that treated cooking, cleaning, and household management as a single discipline worth serious philosophical attention. The Beecher sisters at their most practical.', 40, 12, 'both', false, false, 17, '[]'::jsonb, '[]'::jsonb, '{"sourceBooks": ["The American Woman''s Home"], "maxRecipes": 80, "sortBy": "category"}'::jsonb),
  ('kids-in-the-kitchen', 'Kids in the Kitchen', 'Cooking with the next generation.', 'Fifty recipes and twenty lessons for weekends, homeschool mornings, and the slow transfer of inheritance that happens over a mixing bowl.', 48, 14, 'both', false, true, 18, '[]'::jsonb, '[]'::jsonb, '{"includeTags": ["kid-friendly"], "includeCategories": ["kids-in-the-kitchen", "breakfast-and-bakes", "desserts", "breads"], "difficulties": ["easy"], "maxRecipes": 50, "lessonKidFriendly": true, "maxLessons": 20, "sortBy": "category"}'::jsonb),
  ('family-sunday-book', 'The Family Sunday Book', 'Fifty-two Sunday dinners, one a week.', 'A year of Sunday meals built for a table with children at it. Organized by liturgical season so the week of the year picks the menu.', 38, 11, 'both', false, false, 19, '[]'::jsonb, '[]'::jsonb, '{"celebratory": true, "includeCategories": ["main-dishes", "sides-and-vegetables", "desserts"], "difficulties": ["moderate"], "maxRecipes": 52, "lessonTopics": ["meal-planning", "roasting", "table-setting"], "maxLessons": 6, "sortBy": "category"}'::jsonb)
on conflict (slug) do update set
  title = excluded.title,
  subtitle = excluded.subtitle,
  description = excluded.description,
  price_usd = excluded.price_usd,
  price_pdf_usd = excluded.price_pdf_usd,
