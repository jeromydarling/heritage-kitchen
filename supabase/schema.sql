...
values
  ...
  ('king-arthur-unbleached-bread-flour',
   ...
   'King Arthur is employee-owned, B-Corp certified, and sells the most consistent bread flour you can buy in an American grocery store. It''s the flour our 1890s recipes quietly assume you have — enough protein to build a real crumb, unbleached so it doesn''t fight the yeast.',
   'King Arthur Baking',
  ...
  ('ball-quart-mason-jars-dozen',
   ...
   'Every preserves and pickles recipe in our library wants jars. These are the classic Ball wide-mouth quarts — the ones that fit a ladle without a funnel, that seal cleanly, that you can buy anywhere. Order a dozen in July, use them all by October. Keep the rings; replace the lids.',
   'Ball Corporation',
  ...
  ('diaspora-co-aranya-cinnamon',
   'Aranya Cinnamon',
   'Diaspora Co., India',
   'Diaspora Co. pays Indian spice farmers six times the commodity rate and ships spices within months of harvest instead of years. The Aranya is wild-harvested Sri Lankan true cinnamon — the kind where you can actually smell the difference. A jar lasts a long time and changes every baked thing it touches.',
   'Diaspora Co.',
  ...
  ('new-camaldoli-hermitage-fruitcake',
   ...
   'The Camaldolese hermits on the Big Sur coast make a small quantity of dense, date-and-brandy-heavy fruitcake each winter. Different character from Gethsemani''s — Mediterranean instead of Appalachian — and it sells out every year. Orders open around All Saints.',
   'New Camaldoli Hermitage',
   'https://www.contemplation.com',
   'monastery',
