...
export const sampleRecipes: Recipe[] = [
  {
    ...
    modern_recipe: {
      description:
        'Fluffy, tangy pancakes that rely on buttermilk and baking soda for their lift â€” a classic weekend breakfast from Fannie Farmerâ€™s landmark cookbook.',
      ...
      instructions: [
        ...
        'Pour the wet ingredients into the dry and stir just until combined â€” a few lumps are fine.',
        'Heat a griddle or large nonstick skillet over medium heat and brush lightly with butter.',
        'Drop scant Â¼-cup portions of batter onto the griddle. Cook until the edges look set and bubbles break across the surface, about 2 minutes. Flip and cook another 1â€“2 minutes, until golden.',
    ...
    history_note:
      'In 1896, "sour milk" meant naturally soured farm milk â€” the everyday alternative to sweet milk. When Fannie Farmer standardized measurements at the Boston Cooking School, recipes like this one could finally be followed to the letter by cooks far from her classroom.',
  ...
  },
  {
    ...
    modern_recipe: {
      description:
        'A silky, classic cream of tomato soup. The pinch of baking soda is Fannieâ€™s trick to keep the milk from curdling when it hits the acidic tomatoes.',
      prep_time: '10 minutes',
      ...
      instructions: [
        ...
        'Warm the milk in a small pot until steaming â€” donâ€™t let it boil.',
        ...
        'Whisk in the strained tomato, then the baking soda â€” it will foam briefly. Season with salt and pepper and serve right away.',
      ],
      tips: 'Serve with buttered toast soldiers or oyster crackers for a proper 1890s lunch.',
    },
    history_note:
      'Cream of tomato soup was a novelty dish in the late 19th century, made possible by the new availability of canned tomatoes. Campbellâ€™s would commercialize the formula in 1897, just a year after this recipe appeared.',
  ...
  },
  {
    id: 'mpl-baked-beans',
    title: 'Baked Beans',
    source_book: 'Miss Parloaâ€™s New Cook Book',
    ...
    modern_recipe: {
      description:
        'The long, slow-baked New England classic â€” sweet with molasses, smoky from the pork, and worth starting the day before.',
      prep_time: '15 minutes (plus overnight soak)',
      cook_time: '8 hours',
      servings: '8',
      ingredients: [
        '1 lb (about 2Â¼ cups) dried navy beans',
      ...
      instructions: [
        ...
        'Heat the oven to 275Â°F (135Â°C). Put the beans in a bean pot or Dutch oven. Nestle the pork into the beans so the scored rind just shows on top. Tuck in the onion if using.',
    ...
    history_note:
      'Baked beans in a glazed earthenware pot were a Saturday-night fixture in Puritan New England, cooked overnight to avoid work on the Sabbath. Miss Parloaâ€™s 1887 version is the classic Boston formula.',
  ...
  },
  {
    ...
    modern_recipe: {
      description: 'A plain, honest chocolate layer cake from 1896 â€” tender crumb, deep cocoa flavor, no frills.',
      ...
      instructions: [
        'Heat the oven to 350Â°F (175Â°C). Butter and flour a 9-inch round or 8-inch square pan.',
        ...
        'Scrape into the pan and bake 28â€“32 minutes, until a toothpick comes out with a few moist crumbs. Cool in the pan 10 minutes, then turn out onto a rack.',
      ],
      tips: 'Fannie suggests plain boiled frosting; a simple dusting of powdered sugar is equally period-appropriate.',
    },
    history_note:
      'Chocolate as a baking ingredient was still a relative luxury in 1896, measured in â€œsquaresâ€ of unsweetened baking chocolate from Bakerâ€™s of Dorchester, Massachusetts â€” just a few miles from the Boston Cooking School itself.',
  ...
  },
  {
    ...
    modern_recipe: {
      description: 'Real lemonade, made the way every church-supper cookbook taught it â€” a quick syrup, fresh juice, cold water, and ice.',
      prep_time: '10 minutes',
      cook_time: '0 minutes',
      servings: '1 quart',
      ingredients: [
        ...
        'Â½ cup boiling water',
        'Â¾ cup fresh-squeezed lemon juice (about 6 lemons)',
        '3 cups cold water',
        'Ice',
      ],
      instructions: [
  ...
  },
  {
    ...
    modern_recipe: {
      ...
      ingredients: [
        ...
        '1 cup water',
        'Â¼â€“Â½ cup granulated sugar, to taste',
        'Pinch of freshly grated nutmeg',
        'Squeeze of lemon juice (optional, modern addition)',
      ],
      instructions: [
        'Peel, core, and quarter the apples.',
        'Combine the apples and water in a nonreactive saucepan. Cover and cook over medium-low heat, stirring occasionally, until the apples fall apart â€” about 20 minutes.',
        'Stir in the sugar a little at a time, tasting as you go. Add the nutmeg and a squeeze of lemon juice.',
        'Cook 3â€“5 minutes more to dissolve the sugar. Mash smooth with a spoon, or leave chunky. Serve warm or chilled.',
      ],
      tips: 'A cinnamon stick simmered with the apples is a lovely (and period-appropriate) addition.',
    },
    history_note:
      'Before refrigeration, applesauce was the easiest way to stretch the autumn apple harvest through the winter. Every 19th-century cookbook has a version â€” this one is Miss Parloaâ€™s at its most frugal.',
